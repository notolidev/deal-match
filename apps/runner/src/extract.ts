...
const EXTRACT_SYSTEM =
  ...
  "The candidate is from a DIFFERENT shop/marketplace than where the user is currently browsing — that is expected and desirable. Do NOT reject it for being a different retailer (Amazon, eBay, OnBuy, brand stores, etc. are all valid). " +
